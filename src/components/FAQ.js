    ...
    render() {
        return (
            <div id="faq">
                ...
                <Question id="item06" question="Where will the hackathon take place?" answer="The hackathon will take place in Blagoevgrad, on the campus of the American University in the Sports Hall of the ABF Student Center (check the map below)." />
