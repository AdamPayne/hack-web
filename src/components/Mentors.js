...
import documasterIvayloPhoto from '../assets/mentors/Documaster_Ivailo_Mitrev.webp';
import documasterViktorPhoto from '../assets/mentors/Documaster_Viktor_Ivanov.webp';
	...
	render() {
		return (
			<div className="container" id="mentors">
				...
				<div className="row">
					<Person photo={documasterIvayloPhoto} name="Ivaylo Mitrev" position="Tech Lead, Documaster" biography="I graduated from AUBG in 2014 with two majors – Information Systems and Business Administration and I have been interested in programming from the very beginning. I was a teaching assistant at the university in several disciplines – Statistics, Web Development, and Software Engineering. During my studies, I worked in a few companies where I used VBA, .NET Web Applications, C#, technical documentation and client support. After graduation, I worked with Python, Java, and SQL for Big Data. Currently, I am actively involved with Java, SQL, Spring Integration Patterns and Bash. I also have some minor experience with front end and popular CMS and e-shop systems like Drupal and Magento."></Person>
					<Person photo={documasterViktorPhoto} name="Viktor Ivanov" position="Tech Lead, Documaster" biography="I've worked for two years as a software developer through intern/co-op programs. I have a Master of Science from the University of Kentucky and a Master of Engineering from Cornell. After that, I worked for a year in a department dedicated to preparing documents with technical requirements. From 2011, I work exclusively as a programmer. I have experience with most contemporary languages – C, C++, Python, Perl, Ruby, JavaScript, C#, and Java. I've fiddled with OCaml and Scala. I try to stay away from PHP and the browser-based client-side although I'm well recognized with them."></Person>
